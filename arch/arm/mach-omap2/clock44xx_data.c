...
static struct omap_clk omap44xx_clks[] = {
	...
	CLK("omap-32k-sync-timer", "ick", 	&sys_32k_ck,	CK_44XX),  /* XXX I think duplicate entry with different name should be ok, since there is no initialization/setup for this timer */
	...
	CLK(NULL,       "dpll_mpu_x2_ck",               &dpll_mpu_x2_ck,        CK_44XX),
	...
	CLK(NULL,	"dss_fck",				&dss_fck,	CK_44XX),
	...
	CLK("i2c_omap.1",	"fck",					&i2c1_fck,	CK_44XX),
	CLK("i2c_omap.2",	"fck",					&i2c2_fck,	CK_44XX),
	CLK("i2c_omap.3",	"fck",					&i2c3_fck,	CK_44XX),
	CLK("i2c_omap.4",	"fck",					&i2c4_fck,	CK_44XX),
	...
	CLK("mmci-omap-hs.0",	"fck",					&mmc1_fck,	CK_44XX),
	CLK("mmci-omap-hs.1",	"fck",					&mmc2_fck,	CK_44XX),
	CLK("mmci-omap-hs.2",	"fck",					&mmc3_fck,	CK_44XX),
	CLK("mmci-omap-hs.3",	"fck",					&mmc4_fck,	CK_44XX),
	CLK("mmci-omap-hs.4",	"fck",					&mmc5_fck,	CK_44XX),
	...
	CLK("musb_hdrc",	"ick",					&usb_otg_hs_ick,	CK_44XX),
	...
	CLK(NULL,	"usim_ick",			&usim_ick,	CK_44XX),
	...
	CLK("i2c_omap.1",	"ick",					&dummy_ck,	CK_44XX),
	CLK("i2c_omap.2",	"ick",					&dummy_ck,	CK_44XX),
	CLK("i2c_omap.3",	"ick",					&dummy_ck,	CK_44XX),
	CLK("i2c_omap.4",	"ick",					&dummy_ck,	CK_44XX),
	CLK("mmci-omap-hs.0",	"ick",					&dummy_ck,	CK_44XX),
	CLK("mmci-omap-hs.1",	"ick",					&dummy_ck,	CK_44XX),
	CLK("mmci-omap-hs.2",	"ick",					&dummy_ck,	CK_44XX),
	CLK("mmci-omap-hs.3",	"ick",					&dummy_ck,	CK_44XX),
	CLK("mmci-omap-hs.4",	"ick",					&dummy_ck,	CK_44XX),
