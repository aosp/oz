/*
 * atmel_mxt224.h - Touchscreen driver for Atmel mXT224
 *
 ...
 *
 * Based on:	qt602240_ts.h - AT42QT602240/ATMXT224 Touchscreen driver
...
#ifndef __LINUX_ATMEL_MXT224_H
#define __LINUX_ATMEL_MXT224_H
...
struct atmel_mxt224_platform_data {
	unsigned int x_line;
	unsigned int y_line;
	unsigned int x_size;
	unsigned int y_size;
